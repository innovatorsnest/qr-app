...
const routes = [
    ...
    },
    {
        ...
        component: _shared_login_login_component__WEBPACK_IMPORTED_MODULE_1__["LoginComponent"]
    },
    {
        path: '',
    ...
    {
        path: 'subcategory/:id',
        loadChildren: () => Promise.all(/*! import() | subcategory-subcategory-module */[__webpack_require__.e("common"), __webpack_require__.e("subcategory-subcategory-module")]).then(__webpack_require__.bind(null, /*! ./subcategory/subcategory.module */ "./src/app/subcategory/subcategory.module.ts")).then(m => m.SubcategoryPageModule)
    },
    {
        path: 'products/:id',
        loadChildren: () => Promise.all(/*! import() | products-products-module */[__webpack_require__.e("common"), __webpack_require__.e("products-products-module")]).then(__webpack_require__.bind(null, /*! ./products/products.module */ "./src/app/products/products.module.ts")).then(m => m.ProductsPageModule)
    },
    {
        path: 'header',
        loadChildren: () => __webpack_require__.e(/*! import() | shared-header-header-module */ "common").then(__webpack_require__.bind(null, /*! ./shared/header/header.module */ "./src/app/shared/header/header.module.ts")).then(m => m.HeaderPageModule)
    }
];
...
let DataService = class DataService {
    constructor(_http, router) {
        this._http = _http;
        this.router = router;
        this.url = 'https://www.smartbeings.ai/v1';
    ...
    getOrders() {
        ...
        headers = headers.append('Content-Type', 'application/json');
        headers = headers.append('Authorization', token);
        return this._http.get(this.url + '/fnbOrder/Allorders', { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
    ...
    getAllCategories() {
        ...
        return this._http.get(this.url + '/fnb/categories', { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
    ...
    getAllProductsInsideSubcategory(id) {
        ...
        headers = headers.append('Authorization', token);
        // header  - Authorization
        return this._http.get(this.url + '/fnb/products?subCategoryId=' + id, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
    ...
    createOrder(payload) {
        ...
        return this._http.post(this.url + '/fnbOrder/order', payload, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
    ...
    getAllSubCategoriesOfCategory(id) {
        ...
        headers = headers.append('Authorization', token);
        // header  - Authorization
        return this._http.get(this.url + '/fnb/subCategories/' + id, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((res) => {
...
let LoginComponent = class LoginComponent {
    constructor(route, data, router, helperService) {
        this.route = route;
        this.data = data;
        this.router = router;
...
LoginComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-login',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./login.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/shared/login/login.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./login.component.scss */ "./src/app/shared/login/login.component.scss")).default]
    })
], LoginComponent);
...
module.exports = __webpack_require__(/*! /home/insane/Desktop/Practice Full stack/Official/QR-APP/src/main.ts */"./src/main.ts");
