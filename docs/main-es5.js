(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_login_login_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | subcategory-subcategory-module */
          [__webpack_require__.e("common"), __webpack_require__.e("subcategory-subcategory-module")]).then(__webpack_require__.bind(null,
          /*! ./subcategory/subcategory.module */
          "./src/app/subcategory/subcategory.module.ts")).then(function (m) {
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() | shared-header-header-module */
          "common").then(__webpack_require__.bind(null,
          /*! ./shared/header/header.module */
          "./src/app/shared/header/header.module.ts")).then(function (m) {
    ...
    function srcAppServicesDataServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var DataService = /*#__PURE__*/function () {
        function DataService(_http, router) {
        ...
        _createClass(DataService, [{
          key: "getAccessTokenFromQr",
          value: function getAccessTokenFromQr(payload) {
            console.log("login payload", payload);
            return this._http.post(this.url + "/user/login", payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
              return res;
            }));
          }
        }, {
          ...
          value: function getOrders() {
            ...
            headers = headers.append('Content-Type', 'application/json');
            headers = headers.append('Authorization', token);
            return this._http.get(this.url + '/fnbOrder/Allorders', {
              headers: headers
          ...
          value: function getAllCategories() {
            ...
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]();
            headers = headers.append('Content-Type', 'application/json');
            headers = headers.append('Authorization', token); // header - Authorization

            return this._http.get(this.url + '/fnb/categories', {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
          ...
          key: "getAllProductsInsideSubcategory",
          value: function getAllProductsInsideSubcategory(id) {
            var token = localStorage.getItem('token');
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]();
            headers = headers.append('Content-Type', 'application/json');
            headers = headers.append('Authorization', token); // header  - Authorization

            return this._http.get(this.url + '/fnb/products?subCategoryId=' + id, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
          ...
          key: "createOrder",
          value: function createOrder(payload) {
            var token = localStorage.getItem('token');
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]();
            headers = headers.append('Content-Type', 'application/json');
            headers = headers.append('Authorization', token); // header - Content-Type , Authorization

            return this._http.post(this.url + '/fnbOrder/order', payload, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
          ...
          key: "getAllSubCategoriesOfCategory",
          value: function getAllSubCategoriesOfCategory(id) {
            var token = localStorage.getItem('token');
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]();
            headers = headers.append('Content-Type', 'application/json');
            headers = headers.append('Authorization', token); // header  - Authorization

            return this._http.get(this.url + '/fnb/subCategories/' + id, {
              headers: headers
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
    ...
    function srcAppServicesHelperServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var HelperService = /*#__PURE__*/function () {
        function HelperService(loadingController, toastController) {
    ...
    /***/
    function srcAppSharedLoginLoginComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppSharedLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(route, data, router, helperService) {
          var _this2 = this;
          ...
          this.route.params.subscribe(function (result) {
            ...
            _this2.user.email = result['id'];
            _this2.user.password = result['password'];
          });
        }
        ...
        _createClass(LoginComponent, [{
          ...
          key: "gettingLoginCredentials",
          value: function gettingLoginCredentials() {
            var _this3 = this;
            ...
            if (payload.userName === 'null') {
              ...
              this.data.getAccessTokenFromQr(payload).subscribe(function (response) {
                console.log("%c response from login", "color: yellow", response); // saving the session token to the localstorage as of now
      ...
      LoginComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        ...
        "./src/app/shared/login/login.component.scss"))["default"]]
      })], LoginComponent);
      /***/
    },
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /home/insane/Desktop/Practice Full stack/Official/QR-APP/src/main.ts */
      "./src/main.ts");
      /***/
    }
  }, [[0, "runtime", "vendor"]]]);
