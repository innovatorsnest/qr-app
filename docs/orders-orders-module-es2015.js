...
/* harmony import */ var _services_observable_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../services/observable.services */ "./src/app/services/observable.services.ts");
...
let OrdersPage = class OrdersPage {
    constructor(route, observableService, dataService, helperService, router) {
        this.route = route;
